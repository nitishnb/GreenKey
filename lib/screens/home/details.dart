...
import 'package:green_key/widgets/corouselProductList.dart';
...
class _DetailsScreenState extends State<DetailsScreen> {
  ...
  void openCheckout(Prod product) async {
    var options = {
      ...
      'amount': double.parse(product.discountPrice) * 100,
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<Prod>(
        stream: ProductDatabase(pid: pid).prodData,
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      CarouselProductsList(
                        productsList: [product.productPic],
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Spacer(),
                            Text("Rating : ${double.parse(product.rating) / 2}", style: TextStyle(fontWeight: FontWeight.w900),),
                            RatingBarIndicator(
                              rating: double.parse(product.rating) / 2,
