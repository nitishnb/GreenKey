...
import 'package:green_key/screens/home/product.dart';
import 'package:green_key/screens/home/productList.dart';
...
class _HomelayoutState  extends State<Homelayout> {
  ...
  showAlertDialogBox(BuildContext context) {
    ...
    AlertDialog alert = AlertDialog(
      ...
      content: Text("Oops, sorry you are not allowed to enter this section!"),
      actions: [
        continueButton,
      ],
    );
                        ...
                        child: Column(
                          children: <Widget>[
                            ...
                            Container(
                              ...
                              Icon(Icons.account_box, size: 90,
                                color: Colors.green[600],
                              )
                              :
                              CircleAvatar(
              ...
              bottomNavigationBar: BottomNavigationBar(
                ...
                items: [
                  new BottomNavigationBarItem(
                    icon: Icon(
                      Icons.home, color: Colors.green[600],),
                    title: Text(
                  ...
                  new BottomNavigationBarItem(
                    icon: Icon(
                      Icons.mail, color: Colors.green[600],),
